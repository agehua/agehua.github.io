...
![选择合适的IPC方式](http://blog.conorlee.top/blogimages/2016/androidart_ipc.png)
...
##### (1)Activity启动的大致流程
![Activity启动的大致流程](http://blog.conorlee.top/blogimages/2016/androidart_activity.png)
...
**启动过程：**
![Service1](http://blog.conorlee.top/blogimages/2016/androidart_service1.png)

**绑定过程：**
![Service2](http://blog.conorlee.top/blogimages/2016/androidart_service2.png)

#### 9.4 BroadcastReceiver的工作过程
##### (1)BroadcastReceiver的工作过程包括广播注册过程、广播发送和接收过程。

**注册过程**：静态注册的时候是由PackageManagerService来完成整个注册过程，下面是动态注册的过程
![broadcastreceiver1](http://blog.conorlee.top/blogimages/2016/androidart_broadcastreceiver1.png)
**发送和接收**：
![broadcastreceiver2](http://blog.conorlee.top/blogimages/2016/androidart_broadcastreceiver2.png)
##### (2)广播的发送有几种类型：
...
![ContentProvider](http://blog.conorlee.top/blogimages/2016/androidart_contentprovider.png)
